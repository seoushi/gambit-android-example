...
; File: "fib_.c", produced by Gambit-C v4.6.0
(
406000
" fib_"
(" _kernel" " _system" " _num" " _std" " _eval" " _io" " _nonstd" " _thread" " _repl" " fib")
(
""
"##and"
"##apply"
...
___DEF_SUB_NSTR(___X2,3)
               ___NSTR3(102,105,98)
___DEF_NEW_SYM_GLO_SUP(___S_c_2d_fib,___S_fib,___X2,312890138,___G_fib)
___END_NEW_SYM_GLO(___S_fib,0)
